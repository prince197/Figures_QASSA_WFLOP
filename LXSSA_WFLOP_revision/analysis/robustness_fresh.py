...
if __name__ == "__main__":
    ...
    G.drop(columns=["Coordinates", "Curve"]).to_csv("fresh_reevaluation.csv", index=False)
    out, lines = {}, []
...
\end{table*}
"""
    open("fresh_robust_table.tex", "w").write(tex)
    import json
    json.dump(out, open("fresh_robust_summary.json", "w"), indent=1, default=float)
