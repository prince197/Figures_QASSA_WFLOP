...
\begin{abstract}
The Wind Farm Layout Optimization Problem (WFLOP) is a nonlinear constrained optimization problem in which turbine locations interact through wake-induced velocity deficits. This study employs the Laplacian Salp Swarm Algorithm (LX-SSA), previously introduced by Solanki and Deep in 2023~\cite{Solanki2023}, for continuous WFLOP; LX-SSA is neither proposed nor redesigned in the present paper. The contribution is application-level: the published optimizer is coupled to a continuous turbine-coordinate representation, Jensen wake interactions, direction-dependent Weibull wind statistics, and explicit farm-boundary and minimum-spacing constraints. LX-SSA is compared with SSA, particle swarm optimization (PSO), differential evolution (DE), variable neighbourhood search (VNS) and a gradient-based multistart SLSQP solver on 68 benchmark cases (two wind data sets, three circular farms, 2--15 turbines). Each comparison uses 30 seed-paired runs at an equal budget of 6,030 objective evaluations and is analyzed with Friedman, Holm-corrected Wilcoxon signed-rank and effect-size statistics, together with feasibility rates and convergence curves. VNS performs best (average rank 1.60), followed by SSA, PSO and SLSQP; LX-SSA ranks fifth (3.97), ahead of DE. Against SSA, LX-SSA is never significantly better and is significantly worse in nine cases, so its Laplace follower step brings no equal-budget benefit. The salp-swarm algorithms reach feasible layouts in dense farms more reliably than PSO and DE, but less reliably than VNS and SLSQP. On the Horns Rev~1 offshore site, with its real turbine, wind climate and outline, the same ordering appears, no method improves on the installed layout within the budget, and only the constraint-aware SLSQP finds feasible layouts for the full 80-turbine farm. The algorithm ordering is insensitive to the power-curve model but sensitive to the wake model, and absolute energy values are strongly model-dependent. The conclusions are therefore limited to the stated benchmark, and no new algorithm, wake model or superiority over modern WFLO methods is claimed.
\end{abstract}
...
\begin{table}[!t]
\centering
\caption{Case-level Friedman analysis over all 68 benchmark cases (blocks: cases; ranks of the mean feasible objective, 1 = best). Friedman $\chi^2_F=135.3$ (5 d.f.), $p=1.82\times10^{-27}$; Iman--Davenport $F_F=44.3$. Holm-adjusted $p$ values of the average-rank $z$ test against the best-ranked method (VNS) and against LX-SSA; ``Best'': cases in which the method alone has the highest mean (seven cases are ties); ``Feas.'': percentage of feasible runs.}
\label{tab:friedman68}
\scriptsize\setlength{\tabcolsep}{3pt}
\begin{tabular}{lccccc}
\toprule
Method & Avg.\ rank & Best & Feas.\ (\%) & $p$ vs.\ VNS & $p$ vs.\ LX-SSA \\
\midrule
VNS & 1.60 & 44 & 99.6 & -- & $7.95\times10^{-13}$ \\
SSA & 3.15 & 0 & 97.6 & $1.49\times10^{-6}$ & 0.031 \\
PSO & 3.33 & 9 & 86.0 & $1.44\times10^{-7}$ & 0.092 \\
MS-SLSQP & 3.87 & 6 & 99.9 & $5.05\times10^{-12}$ & 0.748 \\
LX-SSA & 3.97 & 0 & 96.9 & $6.36\times10^{-13}$ & -- \\
DE & 5.08 & 2 & 71.4 & $1.11\times10^{-26}$ & 0.002 \\
\bottomrule
\end{tabular}
\end{table}
\begin{figure}[!t]
\centering
\includegraphics[width=0.95\columnwidth]{figures_fresh/avg_ranks.pdf}
\caption{Average rank of the six methods over the 68 benchmark cases (ranks of the mean feasible objective within each case; 1 = best).}
\label{fig:avgranks}
\end{figure}
\begin{table}[!t]
\centering
...
\midrule
Data Set I & 500 & 9 & 0/9/0 & 2/2/5 & 4/4/1 & 0/5/4 & 2/3/4 \\
Data Set I & 750 & 11 & 0/10/1 & 3/7/1 & 8/2/1 & 0/4/7 & 3/6/2 \\
Data Set I & 1000 & 14 & 0/12/2 & 5/9/0 & 11/3/0 & 0/4/10 & 8/3/3 \\
Data Set II & 500 & 9 & 0/7/2 & 2/4/3 & 4/4/1 & 0/5/4 & 1/4/4 \\
Data Set II & 750 & 11 & 0/8/3 & 3/7/1 & 8/2/1 & 0/5/6 & 1/7/3 \\
Data Set II & 1000 & 14 & 0/13/1 & 3/10/1 & 11/3/0 & 0/4/10 & 3/8/3 \\
\midrule
All & & 68 & 0/59/9 & 18/39/11 & 46/18/4 & 0/27/41 & 18/31/19 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{figures_fresh/wakeloss_vs_n.pdf}
...
\midrule
2 & 28091.5 & \textbf{28091.5 (0.0)} & 28091.5 (0.0) & 28091.5 (0.0) & 28091.5 (0.0) & 28091.5 (0.0) & 28087.2 (4.6) \\
3 & 42137.2 & 42114.8 (14.2) & 42114.9 (10.3) & 42124.7 (8.5) & \textbf{42130.7 (8.8)} & 42119.7 (11.8) & 42116.0 (10.1) \\
4 & 56182.9 & 56078.8 (22.6) & 56086.8 (19.8) & \textbf{56094.3 (13.3)} & 56092.8 (29.8) & 56094.2 (28.5) & 56063.2 (30.9) \\
5 & 70228.7 & 69972.6 (72.0) & 69994.0 (34.0) & \textbf{70010.5 (27.2)} & 69960.5 (78.6) & 69955.1 (126.5) & 69930.5 (113.0) \\
6 & 84274.4 & 83544.9 (465.3) & 83535.6 (372.5) & \textbf{83775.8 (154.1)} & 83326.7 (761.5) & 83738.2 (213.4) & 83601.4 (213.1) \\
7 & 98320.2 & 96380.6 (1013.8) & 96757.0 (692.4) & 96935.0 (485.2) & 95903.3 (1316.3)$^{15}$ & \textbf{97066.5 (484.7)} & 97037.0 (484.3) \\
8 & 112365.9 & 108258.3 (1704.3)$^{28}$ & 109172.6 (1362.4) & 108616.6 (1480.8)$^{24}$ & 107632.7 (1592.8)$^{2}$ & 109981.7 (835.2) & \textbf{110226.6 (585.5)} \\
9 & 126411.6 & 119134.2 (2666.4)$^{21}$ & 120043.1 (2755.8)$^{25}$ & 117175.2 (7148.7)$^{2}$ & --$^{0}$ & 122702.8 (1513.8)$^{29}$ & \textbf{123222.8 (812.6)}$^{28}$ \\
10 & 140457.4 & 130967.4 (3191.0)$^{13}$ & 132616.3 (2328.0)$^{12}$ & --$^{0}$ & 130994.8 (0.0)$^{1}$ & 134084.5 (1603.0)$^{27}$ & \textbf{135461.0 (1291.9)} \\
\bottomrule
\end{tabular}
\end{table*}
\begin{table*}[!t]
...
$N$ & Ideal & LX-SSA & SSA & PSO & DE & VNS & MS-SLSQP \\
\midrule
2 & 28091.5 & \textbf{28091.5 (0.0)} & 28091.5 (0.0) & 28091.5 (0.0) & 28091.5 (0.0) & 28091.5 (0.0) & 28091.0 (1.6) \\
3 & 42137.2 & 42134.2 (4.8) & 42134.4 (4.1) & \textbf{42137.0 (1.1)} & 42136.8 (1.5) & 42134.5 (4.9) & 42132.3 (5.0) \\
4 & 56182.9 & 56149.9 (14.0) & 56153.8 (17.9) & \textbf{56160.0 (14.2)} & 56146.9 (17.5) & 56156.3 (14.4) & 56137.1 (16.4) \\
5 & 70228.7 & 70118.1 (28.6) & 70122.2 (26.3) & 70135.0 (22.6) & 70083.9 (31.7) & \textbf{70137.4 (36.3)} & 70100.5 (42.3) \\
6 & 84274.4 & 84033.5 (58.3) & 84035.2 (58.4) & 84059.1 (42.0) & 83948.2 (74.1) & \textbf{84079.8 (64.2)} & 83947.6 (95.9) \\
7 & 98320.2 & 97840.0 (167.7) & 97875.2 (169.3) & 97872.3 (131.8) & 97479.1 (285.1) & \textbf{97963.6 (80.6)} & 97710.2 (204.8) \\
8 & 112365.9 & 111374.0 (460.8) & 111506.5 (334.5) & 111448.4 (551.6) & 110595.8 (445.6) & \textbf{111801.5 (162.3)} & 111296.2 (217.8) \\
9 & 126411.6 & 124698.0 (960.4) & 124756.2 (610.5) & 124550.0 (794.2) & 121674.9 (2276.5)$^{23}$ & \textbf{125437.8 (379.2)} & 124818.4 (466.3) \\
10 & 140457.4 & 137748.6 (1116.3) & 137817.6 (1160.1) & 137036.8 (1051.3)$^{28}$ & 134937.7 (998.5)$^{4}$ & \textbf{138856.6 (431.7)} & 138184.7 (595.3) \\
11 & 154503.1 & 149863.8 (1886.6)$^{29}$ & 150404.1 (1042.2)$^{29}$ & 149356.6 (1849.0)$^{20}$ & 148555.7 (1134.8)$^{3}$ & \textbf{151831.7 (908.0)} & 151352.9 (560.2) \\
12 & 168548.8 & 161630.5 (1988.2)$^{28}$ & 162903.5 (1685.8) & 160854.7 (2108.4)$^{7}$ & --$^{0}$ & \textbf{165106.7 (762.7)} & 164663.8 (674.6) \\
\bottomrule
\end{tabular}
\end{table*}
\begin{table*}[!t]
...
$N$ & Ideal & LX-SSA & SSA & PSO & DE & VNS & MS-SLSQP \\
\midrule
2 & 28091.5 & \textbf{28091.5 (0.0)} & 28091.5 (0.0) & 28091.5 (0.0) & 28091.5 (0.0) & 28091.5 (0.0) & 28091.3 (0.7) \\
3 & 42137.2 & 42136.7 (1.4) & 42136.7 (1.6) & \textbf{42137.2 (0.0)} & 42137.2 (0.0) & 42137.0 (0.9) & 42135.9 (2.6) \\
4 & 56182.9 & 56172.9 (7.8) & 56169.4 (9.2) & \textbf{56173.0 (6.8)} & 56166.9 (8.4) & 56170.1 (13.3) & 56162.5 (10.5) \\
5 & 70228.7 & 70183.3 (21.0) & 70174.0 (19.7) & 70182.6 (13.0) & 70148.7 (22.4) & \textbf{70186.7 (23.4)} & 70151.4 (32.7) \\
6 & 84274.4 & 84142.7 (23.5) & 84149.9 (29.7) & 84152.3 (22.2) & 84096.1 (24.0) & \textbf{84171.1 (30.2)} & 84087.4 (92.6) \\
7 & 98320.2 & 98078.4 (82.1) & 98084.7 (47.0) & 98083.0 (35.8) & 97942.3 (67.9) & \textbf{98141.0 (51.2)} & 97955.8 (136.6) \\
8 & 112365.9 & 111924.6 (164.7) & 111947.1 (125.7) & 111915.5 (125.3) & 111608.3 (168.9) & \textbf{112038.8 (78.6)} & 111688.0 (181.9) \\
9 & 126411.6 & 125701.5 (265.4) & 125761.1 (168.4) & 125531.1 (324.5) & 124996.3 (282.9) & \textbf{125923.2 (134.4)} & 125366.6 (282.7) \\
10 & 140457.4 & 139354.2 (388.5) & 139348.0 (433.0) & 139018.6 (478.6) & 137969.0 (623.0) & \textbf{139687.2 (221.5)} & 139031.6 (341.6) \\
11 & 154503.1 & 152736.8 (558.8) & 152825.1 (385.8) & 152337.8 (768.8)$^{29}$ & 150189.7 (1068.9)$^{29}$ & \textbf{153426.4 (348.5)} & 152445.9 (402.0) \\
12 & 168548.8 & 165814.4 (827.9) & 166091.9 (816.6) & 165072.5 (1367.5)$^{28}$ & 162390.4 (1765.9)$^{17}$ & \textbf{166906.5 (459.2)} & 166188.4 (681.0) \\
13 & 182594.6 & 178913.6 (967.4) & 179101.5 (1028.9) & 177302.0 (2352.6)$^{22}$ & 174763.4 (1389.6)$^{4}$ & \textbf{180466.7 (599.8)} & 179465.2 (506.2) \\
14 & 196640.3 & 191046.6 (1754.6) & 192235.7 (1504.8) & 190385.1 (1544.4)$^{18}$ & --$^{0}$ & \textbf{193732.7 (887.0)} & 192677.8 (595.4) \\
15 & 210686.1 & 203681.8 (1899.5)$^{29}$ & 204777.6 (1420.5) & 201985.5 (1678.3)$^{9}$ & --$^{0}$ & \textbf{206859.5 (910.3)} & 206059.6 (761.8) \\
\bottomrule
\end{tabular}
\end{table*}
\begin{table*}[!t]
...
$N$ & Ideal & LX-SSA & SSA & PSO & DE & VNS & MS-SLSQP \\
\midrule
2 & 14630.8 & \textbf{14630.8 (0.0)} & 14630.8 (0.0) & 14630.8 (0.0) & 14630.8 (0.0) & 14630.8 (0.0) & 14626.0 (5.6) \\
3 & 21946.1 & 21899.7 (9.5) & 21900.9 (11.1) & 21901.5 (6.3) & 21901.2 (5.5) & \textbf{21906.5 (23.0)} & 21888.8 (45.5) \\
4 & 29261.5 & 29004.2 (87.4) & 29028.7 (93.8) & \textbf{29077.9 (64.5)} & 29044.2 (61.5) & 29028.5 (66.7) & 28998.9 (104.2) \\
5 & 36576.9 & 35880.1 (168.6) & 35918.9 (74.0) & 35959.4 (119.0) & 35789.6 (193.8) & \textbf{35976.5 (173.2)} & 35896.9 (110.0) \\
6 & 43892.3 & 42512.1 (227.9) & 42444.3 (224.5) & 42568.5 (159.7) & 42257.5 (374.9) & \textbf{42626.6 (192.4)} & 42590.7 (236.0) \\
7 & 51207.6 & 48626.5 (340.5) & 48887.9 (304.1) & 48885.9 (278.3) & 48203.9 (767.8)$^{15}$ & \textbf{49171.8 (236.9)} & 49007.9 (208.2) \\
8 & 58523.0 & 54699.5 (620.7)$^{28}$ & 54900.5 (471.3) & 54693.1 (404.3)$^{24}$ & 54451.3 (618.7)$^{2}$ & 55331.0 (323.5) & \textbf{55457.2 (287.3)} \\
9 & 65838.4 & 59963.3 (652.2)$^{21}$ & 60581.0 (844.8)$^{25}$ & 61035.6 (137.9)$^{2}$ & --$^{0}$ & \textbf{61509.3 (538.6)}$^{29}$ & 61457.0 (370.7) \\
10 & 73153.8 & 65868.7 (586.0)$^{13}$ & 65880.7 (761.6)$^{12}$ & --$^{0}$ & 64240.2 (0.0)$^{1}$ & 67141.9 (581.4)$^{27}$ & \textbf{67288.3 (300.1)}$^{29}$ \\
\bottomrule
\end{tabular}
\end{table*}
\begin{table*}[!t]
...
$N$ & Ideal & LX-SSA & SSA & PSO & DE & VNS & MS-SLSQP \\
\midrule
2 & 14630.8 & \textbf{14630.8 (0.0)} & 14630.8 (0.0) & 14630.8 (0.0) & 14630.8 (0.0) & 14630.8 (0.0) & 14630.4 (1.5) \\
3 & 21946.1 & 21937.3 (8.1) & 21940.0 (8.2) & \textbf{21943.2 (5.4)} & 21942.5 (5.8) & 21941.5 (6.8) & 21938.2 (12.2) \\
4 & 29261.5 & 29201.4 (25.7) & 29182.5 (36.2) & \textbf{29213.0 (20.4)} & 29195.3 (26.2) & 29202.4 (32.5) & 29179.0 (59.2) \\
5 & 36576.9 & 36366.8 (74.3) & 36332.0 (91.4) & 36400.0 (62.2) & 36277.7 (105.9) & \textbf{36405.5 (82.8)} & 36283.6 (98.0) \\
6 & 43892.3 & 43377.4 (175.7) & 43419.5 (153.1) & 43441.8 (107.5) & 43142.2 (144.8) & \textbf{43470.4 (120.0)} & 43283.1 (153.3) \\
7 & 51207.6 & 50095.4 (193.6) & 50264.8 (202.5) & 50188.2 (199.5) & 49696.6 (156.3) & \textbf{50324.3 (194.4)} & 50164.7 (205.9) \\
8 & 58523.0 & 56659.2 (332.0) & 56806.2 (303.6) & 56786.4 (311.8) & 56033.1 (331.4) & \textbf{57063.0 (286.7)} & 56752.4 (256.7) \\
9 & 65838.4 & 63252.7 (342.8) & 63291.6 (402.5) & 63180.2 (411.7) & 61970.8 (763.0)$^{23}$ & \textbf{63680.4 (415.5)} & 63381.6 (322.9) \\
10 & 73153.8 & 69480.7 (385.7) & 69520.3 (512.6) & 69159.6 (436.1)$^{28}$ & 68103.2 (423.7)$^{4}$ & \textbf{70300.6 (409.0)} & 69972.9 (458.1) \\
11 & 80469.2 & 75181.6 (681.1)$^{29}$ & 75742.5 (677.1)$^{29}$ & 75199.6 (585.7)$^{20}$ & 74596.6 (476.3)$^{3}$ & \textbf{76504.5 (395.7)} & 76284.4 (433.9) \\
12 & 87784.5 & 81341.8 (792.1)$^{28}$ & 81822.1 (625.7) & 80936.3 (798.4)$^{7}$ & --$^{0}$ & 82731.2 (470.9) & \textbf{82867.2 (399.2)} \\
\bottomrule
\end{tabular}
\end{table*}
\begin{table*}[!t]
...
$N$ & Ideal & LX-SSA & SSA & PSO & DE & VNS & MS-SLSQP \\
\midrule
2 & 14630.8 & \textbf{14630.8 (0.0)} & 14630.8 (0.0) & 14630.8 (0.0) & 14630.8 (0.0) & 14630.8 (0.0) & 14630.5 (1.0) \\
3 & 21946.1 & 21945.3 (2.8) & 21945.6 (1.8) & 21945.8 (2.0) & \textbf{21946.1 (0.0)} & 21945.6 (1.7) & 21943.5 (4.8) \\
4 & 29261.5 & 29228.0 (14.9) & 29232.5 (18.5) & 29243.3 (13.6) & 29225.9 (12.1) & \textbf{29246.6 (13.5)} & 29218.7 (24.2) \\
5 & 36576.9 & 36468.2 (46.1) & 36485.9 (37.5) & 36486.0 (36.0) & 36402.8 (39.4) & \textbf{36499.6 (38.8)} & 36432.0 (50.4) \\
6 & 43892.3 & 43656.6 (73.3) & 43626.4 (74.5) & 43665.8 (65.6) & 43488.5 (69.7) & \textbf{43700.2 (82.3)} & 43524.8 (86.8) \\
7 & 51207.6 & 50727.3 (119.3) & 50731.8 (118.8) & 50739.2 (134.6) & 50442.7 (136.0) & \textbf{50785.0 (110.8)} & 50582.5 (165.5) \\
8 & 58523.0 & 57645.1 (186.6) & 57739.3 (142.0) & 57616.2 (157.7) & 57210.0 (191.8) & \textbf{57854.1 (163.9)} & 57560.8 (206.6) \\
9 & 65838.4 & 64428.7 (273.1) & 64476.4 (203.0) & 64308.4 (234.8) & 63790.1 (227.2) & \textbf{64652.4 (279.3)} & 64419.1 (268.8) \\
10 & 73153.8 & 71099.4 (266.9) & 71139.4 (336.8) & 70985.2 (314.4) & 70190.1 (286.9) & \textbf{71535.7 (321.0)} & 71161.4 (275.8) \\
11 & 80469.2 & 77561.6 (498.0) & 77697.5 (425.8) & 77501.2 (352.1)$^{29}$ & 75960.9 (577.6)$^{29}$ & \textbf{78281.9 (285.9)} & 77812.4 (323.7) \\
12 & 87784.5 & 83981.2 (515.0) & 84049.6 (660.3) & 83795.7 (565.1)$^{28}$ & 82211.6 (905.2)$^{17}$ & \textbf{85002.5 (322.8)} & 84312.7 (466.3) \\
13 & 95099.9 & 90303.5 (674.2) & 90267.0 (482.6) & 90139.1 (533.9)$^{22}$ & 88665.1 (496.0)$^{4}$ & \textbf{91538.1 (357.6)} & 90837.9 (572.0) \\
14 & 102415.3 & 96229.6 (1019.3) & 96936.5 (669.3) & 96266.2 (730.7)$^{18}$ & --$^{0}$ & \textbf{97983.6 (409.3)} & 97276.4 (405.3) \\
15 & 109730.7 & 102327.4 (838.7)$^{29}$ & 102746.3 (827.8) & 101804.8 (571.6)$^{9}$ & --$^{0}$ & \textbf{104036.5 (619.7)} & 103853.3 (475.2) \\
\bottomrule
\end{tabular}
\end{table*}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{figures_fresh/feasibility_vs_n.pdf}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{figures_fresh/convergence_mid.pdf}
\caption{Convergence for moderate turbine counts: median (line) and interquartile range (band) over the 30 runs of the best feasible wake loss found so far, versus the number of objective calls (logarithmic scale). A curve starts once at least half of the runs have found a feasible layout.}
\label{fig:conv-mid}
\end{figure*}
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{figures_fresh/convergence_max.pdf}
\caption{Convergence for the largest turbine count of each farm (as Fig.~\ref{fig:conv-mid}). Methods for which fewer than half of the runs find a feasible layout within the budget have no curve (PSO and DE, and LX-SSA and SSA at 500~m/10).}
\label{fig:conv-max}
\end{figure*}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{figures_fresh/boxplots_mid.pdf}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{figures_fresh/layouts_max.pdf}
\caption{Best layouts for the largest turbine count of each farm: best LX-SSA run (filled circles) and best run of any method (open squares, method in the legend). Circle: farm boundary. Coordinates are listed in Appendix~\ref{app:coordinates}.}
\label{fig:layouts}
\end{figure*}
...
\midrule
LX-SSA & 136.46 (0.90) & 8.58 & 28/30 & -- & -- & -- & 0/10 \\
SSA & 136.66 (1.00) & 8.44 & 30/30 & 0.262 & -- & -- & 0/10 \\
PSO & -- & -- & 0/30 & $9.31\times10^{-9}$ & -- & -- & 0/10 \\
DE & -- & -- & 0/30 & $9.31\times10^{-9}$ & -- & -- & 0/10 \\
VNS & 137.97 (0.80) & 7.57 & 29/30 & $1.68\times10^{-4}$ & -- & -- & 0/10 \\
MS-SLSQP & 136.80 (0.77) & 8.35 & 30/30 & 0.085 & 653.9 (2.6) & 12.39 & 10/10 \\
\bottomrule
\end{tabular}
\end{table*}
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{figures_fresh/hr_convergence.pdf}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{figures_fresh/hr_layouts.pdf}
